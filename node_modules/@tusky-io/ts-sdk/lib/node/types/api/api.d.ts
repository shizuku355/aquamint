...
import { CreateVaultTxPayload, CreateFolderTxPayload, UpdateVaultTxPayload, UpdateFolderTxPayload, UpdateMembershipTxPayload, CreateMembershipTxPayload, UpdateFileTxPayload, CreateFolderTreeTxPayload } from "../types/transaction";
...
declare abstract class Api {
    ...
    abstract createAuthChallenge(payload: CreateChallengeRequestPayload): Promise<{
        nonce: string;
    }>;
    ...
    abstract createFolderTree(tx: CreateFolderTreeTxPayload): Promise<{
    ...
    abstract getCollections(options?: ListOptions): Promise<Paginated<Collection>>;
