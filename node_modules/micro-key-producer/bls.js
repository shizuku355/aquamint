...
function parentSKToLamportPK(parentSK, index) {
    ...
    return (0, sha256_1.sha256)((0, utils_2.concatBytes)(...lamportPK));
}
/**
...
function decryptEIP2335Keystore(store, password) {
    ...
    // verify checksum
    const checksum = (0, utils_2.bytesToHex)((0, sha256_1.sha256)((0, utils_2.concatBytes)(key.subarray(16, 32), ciphertext)));
...
class EIP2335Keystore {
    ...
    description = '', pubkey) {
        ...
        const checksum = (0, utils_2.bytesToHex)((0, sha256_1.sha256)((0, utils_2.concatBytes)(key.subarray(16), ciphertext)));
        const res = {
            version: 4,
            description,
            path,
